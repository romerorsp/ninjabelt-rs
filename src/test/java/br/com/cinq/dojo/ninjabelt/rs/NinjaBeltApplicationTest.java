...
@ActiveProfiles(NinjaBeltApplicationTest.ACTIVE_PROFILE)
@RunWith(SpringRunner.class)
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
public class NinjaBeltApplicationTest {
  ...
  public void shouldReturnUnitEnvironment() {
    final URI uri = URI.create(String.format("http://localhost:%d/ninjabelt-rs/environment", port));
